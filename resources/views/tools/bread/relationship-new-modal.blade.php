        ...
        <div class="modal-dialog relationship-panel">
            <div class="model-content">
                    ...
                    <div class="row">
                        ...
                        @if(isset($dataType->id))
                            <div class="col-md-12 relationship_details">
                                ...
                                <span><input type="text" class="form-control" name="relationship_model"
                                             placeholder="{{ __('voyager::database.relationship.namespace') }}"
                                             value="@if(isset($relationshipDetails->model)){{ $relationshipDetails->model }}@endif"></span>
                            </div>
                            <div class="col-md-12 relationship_details relationshipField">
                                <div class="belongsTo">
                                    <label>{{ __('voyager::database.relationship.which_column_from') }}
                                        <span>{{ str_singular(ucfirst($table)) }}</span> {{ __('voyager::database.relationship.is_used_to_reference') }}
                                        <span class="label_table_name"></span>?</label>
                                ...
                                <div class="hasOneMany flexed">
                                    <label>{{ __('voyager::database.relationship.which_column_from') }} <span
                                                class="label_table_name"></span> {{ __('voyager::database.relationship.is_used_to_reference') }}
                                        <span>{{ str_singular(ucfirst($table)) }}</span>?</label>
                                    <select name="relationship_column" class="new_relationship_field select2 rowDrop"
                            ...
                            <div class="col-md-12 relationship_details_more">
                                <div class="well">
                                    ...
                                    <p><strong>{{ __('voyager::database.relationship.display_the') }} <span
                                                    class="label_table_name"></span>: </strong>
                                        <select name="relationship_label" class="rowDrop select2"
                                                data-table="{{ $tables[0] }}" data-selected="">
                                        </select>
                                    </p>
                                    <p class="relationship_key">
                                        <strong>{{ __('voyager::database.relationship.store_the') }} <span
                                                    class="label_table_name"></span>: </strong>
                                        <select name="relationship_key" class="rowDrop select2"
                                                data-table="{{ $tables[0] }}" data-selected="">
                                        </select>
                                    </p>
                                </div>
                ...
                <p class="relationship_taggable"><strong>{{ __('voyager::database.relationship.allow_tagging') }}:</strong> <br>
                        ...
                        @else
                            <div class="col-md-12">
                                <h5><i class="voyager-rum-1"></i> {{ __('voyager::database.relationship.easy_there') }}
                                </h5>
                    ...
                    <div class="relationship-btn-container">
                        ...
                        @if(isset($dataType->id))
                            <button class="btn btn-danger btn-relationship"><i class="voyager-plus"></i>
                                <span>{{ __('voyager::database.relationship.add_new') }}</span></button>
                        @endif
                    </div>
                </div>
            </div>
